  ...
  return (
    <div>
      ...
      <div className="flex items-center justify-center flex-col my-12">
        <EmailVerification />
        <h2 className="uppercase tracking-[3px] text-2xl sm:text-4xl text-center my-4">
        start shopping
        </h2>
        ...
        <Link
          href="/login"
          className="w-[200px] uppercase sm:w-[300px] hover:bg-[#1B2E3C] hover:text-[#F3E3E2] border border-[#0C0C1E] text-center rounded-lg my-8 py-4 text-sm"
        >
          proceed to login
        </Link>
      </div>
